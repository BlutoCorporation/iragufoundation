            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-3">
                    <div class="cookie-toggle-wrapper">
                        <div class="toggle-button on" id="cookieToggle">
                            <span class="material-icons icon check">check</span>
                            <span class="material-icons icon close">close</span>
                        </div>
                        <span class="cookie-text">Cookie Preferences</span>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <!-- Footer Menu Start -->
                    <div class="footer-copyright-text">
                        <p>Designed and Developed by <a href="http://bluto.zeal.lol/">Bluto Corporation</a></p>
                    </div>
                    <!-- Footer Menu End -->
                </div>
            </div>
...
.toggle-button.off .check {
    opacity: 0.4;
}

.toggle-button.off .close {
    opacity: 1;
}

.toggle-button.on .check {
    opacity: 1;
}
