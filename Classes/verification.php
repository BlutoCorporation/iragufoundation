        ...
        <section class="auth d-flex">
            ...
            <div class="auth-right py-40 px-24 flex-center flex-column">
                <div class="auth-right__inner mx-auto w-100">
                    ...
                    <p class="text-gray-600 text-15 mb-32">OTP sent to your email address: <span class="fw-medium"> <?= htmlspecialchars($emailToShow) ?></span> Please enter OTP verify your account.</p>
                    ...
                    <form class="d-flex justify-content-between mt-32" method="POST" action="verify-email">
                        <a href="forgot-password" class="d-flex align-items-center"> <i class="ph ph-arrow-left d-flex align-item-center me-5"></i> Go Back</a>
